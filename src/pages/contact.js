        ...
        <Fade duration={1200}>
          <div className="bg-offblack opacity-70 p-10  md:w-3/4 m-5 xxs:w-auto">
            ...
            >
              ...
              <textarea
                className="mt-5 w-full bg-offblack border border-white bg-opacity-20 rounded-xl p-5 text-white focus:outline-none focus:ring-2 focus:ring-yellow focus:border-transparent"
                rows="5"
